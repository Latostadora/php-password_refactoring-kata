 ...
 */
class GanianesCorp_Apps_Web_Backend_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->aliases = [
            'GanianesCorp\\Apps\\Web\\Backend\\Kernel' => 'kernel',
        ];
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/GanianesCorp_Apps_Web_Backend_KernelTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => '/Users/juanbarrerolopez/projects/latostadora/php-password_refactoring-kata/vendor/symfony/framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'GanianesCorp_Apps_Web_Backend_KernelTestDebugContainer',
